                ...
                data.map((mappedData, key) => {
                    if (key < visibleCardsLimit) {
                        return <Link key={"card-" + key} to={mappedData.url} target="_blank" className="card">
                            {
                                location.pathname == "/" && <div className="card__floating-buttons" onClick={(e) => e.preventDefault()}>
                                    {
                                        !isLoggedIn && <span className="floating-buttons__info">
                            ...
                            {
                                location.pathname == "/saved-articles" && <div className="card__floating-buttons" onClick={(e) => e.preventDefault()}>
                                    <span className="floating-buttons-keyword">
                                        {mappedData.keyword}
                                    </span>
