...
export default function SearchForm() {
    ...
    return (
        <form className="search" onSubmit={handleSubmit}>
            <input type="text" name="search" className="search__input" placeholder="Enter topic" value={searchValueGetter.q} onChange={(e) => handleInputChange(e, "q", searchValueSetter)} required/>
